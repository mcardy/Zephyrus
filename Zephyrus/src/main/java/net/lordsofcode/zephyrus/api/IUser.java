...
public interface IUser {
	...
	/**
	 * Whether or not the user has the spell's permission. 
	 * Will only return true if the user has permission and op-knowledge is enabled in the config.
	 * @param spell The spell to check
	 * @return
	 */
	 ...
	 * @param mana The amount of mana to check
	 * @return True if the user has the specified amount of mana or more, false otherwise.
	 */
	public boolean hasMana(int mana);
	
	/**
	 * Drains mana from the user
	 * @param mana The amount to drain
	 ...
	 * @param sender The CommandSender to display the mana to
	 */

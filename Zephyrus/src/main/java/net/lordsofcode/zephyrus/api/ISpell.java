...
public interface ISpell extends Listener {
	...
	/**
	 * Gets the spell's display name. Usually used to get the name from a config file
	 * @return The spell's display name
	 */
	public String getDisplayName();
	
	/**
	 * Gets the default description of the spell
	 * @return The default description of the spell
	 */
	public String getDesc();
	
	/**
	 * Gets the display description of the spell. Usually used to get the description from a config file. 
	 * @return The spell's display description
	 */
	public String getDisplayDesc();
	
	/**
	 * Gets the spell's required spell. Spell.forName()
	 * @return Null if there is no required spell
	 */
	public ISpell getRequiredSpell();
	
	/**
	 * Gets the configurations for the spell
	 * @return Null if there are none.
	 */
	public Map<String, Object> getConfiguration();
	
	/**
	 * Gets the default reqired level to learn the spell. This level multiplied by 100 should be higher than the mana cost multiplied by 5.
	...
	/**
	 * Gets the mana cost usually from the config (though may be different with external spells) 
	 * @return
	 */
	public int getManaCost();
	
	/**
	 * Whether or not the spell can be bound to a wand or any other similar object.
	...
	/**
	 * Gets the items required to craft the spell. Used for getting items from config
	 * @return
	 */
	...
	/**
	 * Gets the Priority of the spell
	 * @return
	 */
	 ...
	 * @param args The arguments used to cast the spell
	...
	/**
	 * NOT IMPLEMENTED YET! The spell's combo spell effect.
	 * @param player The player who cast the spell
	 * @param args The arguments used to cast the spell
	 * @param type The type of spell the other spell is
	 * @param element The element the other spell is
